...
import com.example.fimebookandmarket2.Model.Cart;
import com.example.fimebookandmarket2.Prevalent.Prevalent;
import com.example.fimebookandmarket2.ViewHolder.CartViewHolder;
...
public class CartActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<Cart> options =
                new FirebaseRecyclerOptions.Builder<Cart>().setQuery(cartListRef.child("User View").child(Prevalent.currentOnlineUser.getId()).child("Productos"), Cart.class).build();
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    if(shippingState.equals("shipped")){
                        ...
                        txtTotalAmount.setText(overTotalPrice + "\n Su orden se entrego correctamente.");
                        recyclerView.setVisibility(View.GONE);

                        txtMsg1.setVisibility(View.VISIBLE);
                        txtMsg1.setText("Tu orden se entrego correctamente.");
                        NextProcessBtn.setVisibility(View.GONE);

                        Toast.makeText(CartActivity.this, "Puedes comprar mas productos, una vez que se te haga entrega de la orden actual.", Toast.LENGTH_SHORT).show();

                    } else if(shippingState.equals("not shipped")){

                        txtTotalAmount.setText("Estado de envio: No entregado");
                        recyclerView.setVisibility(View.GONE);
