    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addToCartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(state.equals("Pedido realizado") || state.equals("Envio de la orden")){
                    Toast.makeText(ProductDetailsActivity.this, "Puedes comprar mas productos, una vez tu orden fue enviada o confirmada.", Toast.LENGTH_SHORT).show();
                } else {
                    addingToCartList();
                }
            }
